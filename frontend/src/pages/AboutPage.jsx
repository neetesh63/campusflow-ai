      ...
      <main className="flex-1 max-w-5xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          ...
          <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800 text-center">
            ...
            <p className="text-xs text-slate-400 mt-1">Google Gemini 1.5 API with Intelligent Offline Fallback</p>
          </div>
        </div>
        ...
        <div className="mt-12 p-8 rounded-3xl bg-slate-900/60 border border-slate-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-xs text-slate-300">
            ...
            <div className="flex gap-3">
              ...
              <div>
                <strong className="text-slate-100 block text-sm">Zero API Downtime Design</strong>
                Features robust fallback response generators so the platform remains 100% operational even without API credentials.
              </div>
            </div>
